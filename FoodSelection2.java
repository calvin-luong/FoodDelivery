...
public class FoodSelection2 extends JFrame {
	 ...
	 * Create the frame.
	 */
	public FoodSelection2(String rn, int pos) {
		...
		String[] foods = {"", "Chicken Tenders", "Chicken Wings", "Chicken Wrap"};
		...
		public void actionPerformed(ActionEvent e)
		{
			if (e.getSource() == foodbox)
			{
				...
				{
				case "":;
				case "Chicken Tenders": i += 6.50; cost.setText(Double.toString(i)); orderedFood = "Chicken Tenders"; break;
				case "Chicken Wings": i += 6.50; cost.setText(Double.toString(i)); orderedFood = "Chicken Wings"; break;
				case "Chicken Wrap": i += 5.00; cost.setText(Double.toString(i)); orderedFood = "Chicken Wrap"; break;
				}
			}
		}}
		);
		...
		String[] meals = {"", "Chicken Meal", "Kids Meal"};
		...
		public void actionPerformed(ActionEvent e)
		{
			if (e.getSource() == mealbox)
			{
				...
				{
				case "":;
				case "Chicken Meal": i += 30.00; cost.setText(Double.toString(i)); orderedMeal = "Chicken Meal"; break;
				case "Kids Meal": i += 10.00; cost.setText(Double.toString(i)); orderedMeal = "Chicken Meal"; break;
				}
			}
		}}
		);
